...
class _QuizPageState extends State<QuizPage> {
  ...
  void _answerQuestion(String selectedAnswer) {
    Object? correctAnswer = _quizData[_questionIndex]['correctAnswer'];
          ...
          ? Stack(
              children: [
                Padding(
                  ...
                  child: Center(
                    child: Quiz(
                      question: _quizData[_questionIndex]['question'] as String,
                      answers:
                          _quizData[_questionIndex]['answers'] as List<String>,
